 ...
 * on screen and when.
 *
 * Note the chat takes an instruction, not a bare URL: "summarize
 * https://youtube.com/watch?v=..." rather than the link on its own. The
 * captions say so, because a viewer who pastes only a link gets nothing.
 */
export const ep01: Omit<EpisodeProps, 'format'> = {
  ...
  lowerThirds: [
    { at: 3, title: 'Ask for a summary', detail: 'Note Companion Chat' },
  ...
  captions: [
    ...
    { from: 9.0, to: 13.0, text: 'Instead, drop the link in chat and ask for a summary.' },
    ...
    { from: 51.0, to: 56.0, text: 'One link. One note. Nothing to file.' },
